...
<?php
	...
	$products_prepare = $connection->prepare($products_query);
			...
			<div class="book p-4">
				...
				<form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" class="appointment-form">
						...
						<div class="form-group">
							<div class="input-wrap">
								...
								<input type="text" name="date" class="form-control appointment_date"
									data-date-start-date="+1d" placeholder="Date">
							</div>
						</div>
						<div class="form-group ml-md-4">
							<div class="input-wrap">
					...
					<div class="d-md-flex">
						...
						<div class="form-group ml-md-4">
							<input type="submit" value="Appointment" name="submit" class="btn btn-white py-3 px-4">
						</div>
					</div>
				</form>
			</div>
